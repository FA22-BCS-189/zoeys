...
import { Mail, Phone, MapPin, Crown, Heart } from 'lucide-react';
    ...
    <footer className="bg-gradient-to-b from-navy-800 to-navy-900 text-softwhite relative overflow-hidden">
      ...
      <div className="container-custom py-12 md:py-16 relative px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10 mb-10">
          {/* Brand - Full width on mobile, then adjusts on larger screens */}
          <div className="space-y-4 md:col-span-2 lg:col-span-1 text-center md:text-left">
            <div className="flex items-center space-x-3 justify-center md:justify-start">
              <Crown className="w-8 h-8 text-emerald-400" />
              <div>
                <h3 className="text-2xl font-display font-bold text-emerald-400">Zoey's</h3>
            ...
            <p className="text-sm text-softwhite/80 leading-relaxed">
              Handcrafted embroidered masterpieces from the heart of Bahawalpur, 
              preserving centuries of traditional craftsmanship for the modern connoisseur.
            </p>
          ...
          {/* Three columns side by side on mobile and up */}
          <div className="grid grid-cols-3 gap-6 md:gap-8 md:col-span-2 lg:col-span-3">
            ...
            <div className="text-center md:text-left">
              ...
              <ul className="space-y-2">
                <li>
                  <Link 
                    to="/shop" 
                    className="text-sm text-softwhite/80 hover:text-emerald-300 transition-colors flex items-center group justify-center md:justify-start"
                  >
            ...
            <div className="text-center md:text-left">
              ...
              <ul className="space-y-2">
                <li>
                  <Link 
                    to="/shop?collection=lawn-pakka-tanka" 
                    className="text-sm text-softwhite/80 hover:text-emerald-300 transition-colors flex items-center group justify-center md:justify-start"
                  >
                    <span className="w-0 group-hover:w-2 h-px bg-emerald-400 transition-all mr-0 group-hover:mr-2" />
                    Lawn Pakka Tanka
                ...
                <li>
                  <Link 
                    to="/shop?collection=embellished" 
                    className="text-sm text-softwhite/80 hover:text-emerald-300 transition-colors flex items-center group justify-center md:justify-start"
                  >
                    <span className="w-0 group-hover:w-2 h-px bg-emerald-400 transition-all mr-0 group-hover:mr-2" />
                    Embellished
                ...
                <li>
                  <Link 
                    to="/shop" 
                    className="text-sm text-emerald-300 hover:text-emerald-200 transition-colors font-medium flex items-center group mt-3 justify-center md:justify-start"
                  >
            ...
            {/* Contact - Mobile: Link to contact page, Desktop: Show contact details */}
            <div className="text-center md:text-left">
              <h4 className="font-display font-bold text-emerald-300 mb-4 text-lg relative inline-block">
                Contact Us
                <div className="absolute -bottom-1 left-1/2 md:left-0 transform -translate-x-1/2 md:translate-x-0 w-8 h-0.5 bg-emerald-400" />
              ...
              {/* Mobile: Simple link to contact page */}
              <div className="block md:hidden">
                <Link 
                  to="/contact" 
                  className="text-sm text-softwhite/80 hover:text-emerald-300 transition-colors flex items-center group justify-center"
                >
                  <span className="w-0 group-hover:w-2 h-px bg-emerald-400 transition-all mr-0 group-hover:mr-2" />
                  Get In Touch
                </Link>
              ...
              <ul className="space-y-3 hidden md:block">
                ...
                <li className="flex items-start space-x-3 group">
                  ...
                  <a 
                    href="mailto:zaiinabsanaullah@gmail.com" 
        ...
        <div className="flex flex-col md:flex-row justify-between items-center space-y-3 md:space-y-0 text-center">
          <p className="text-sm text-softwhite/70">
            © {currentYear} <span className="text-emerald-300 font-semibold">Zoey's</span>. 
            Crafted with <Heart size={12} className="inline text-emerald-400 mx-1" /> in Bahawalpur
          </p>
        </div>
      </div>
